...
**Phase 6.1 — Visualization Foundation** is the current milestone. It provides the
reusable foundation that every later visualization builds on; it does **not**
implement any concrete visualization yet.

| Milestone | Description | Status |
|-----------|-------------|--------|
| 6.1 | Visualization Foundation | ✅ Implemented |
| 6.2 | Genome Browser | 📋 Planned |
...
Phase 6.1 is intentionally lightweight. It uses only the existing web stack
(React, TypeScript, Tailwind CSS) plus SVG/Canvas-ready layout primitives. No
C++, WebAssembly, WebGPU, Three.js, Cytoscape.js, or D3.js is used — those are
